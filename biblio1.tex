...
\newblock [Consulté le 20 Octobre 2015].

\bibitem[\bfseries BUC00]{web02}
Nicolas \bgroup\fonteauteurs\bgroup BUCHY\egroup\egroup{} :
\newblock La gestion de la maintenance assistée par ordinateur et la
...
Ministère de~\bgroup\fonteauteurs\bgroup l'Industrie\egroup\egroup{} :
...
\newblock Introduction aux systèmes d'information.
\newblock Cours de système d'information (2CPI), Ecole nationale superieure
d'informatique, ALGER, 2013.

\bibitem[\bfseries KAF01]{ref04}
Hédi \bgroup\fonteauteurs\bgroup KAFFEL\egroup\egroup{} :
\newblock {\em Contribution La maintenance distribué: concepts, évaluation et
  mise en \oe uvre}.
\newblock Th\`ese de doctorat, université laval québec, Octobre 2001.

\bibitem[\bfseries LAC11]{web08}
Mohamed-Chérif \bgroup\fonteauteurs\bgroup LACHICHI\egroup\egroup{} :
...
\newblock Ed. Techniques Ingénieur, 2004.

\bibitem[\bfseries MON00]{ref01}
François \bgroup\fonteauteurs\bgroup MONCHY\egroup\egroup{} :
\newblock {\em Maintenance: Méthodes et organisations}.
\newblock Dunod \'edition, 2000.

\bibitem[\bfseries Oph08]{ref05}
D.~\bgroup\fonteauteurs\bgroup Ophelie\egroup\egroup{} :
\newblock Gestion de la maintenance assistée par ordinateur.
...
\newblock {\em La gestion des équipements: vers l'entretien préventif}.
\newblock Association paritaire pour la santé et la sécurité du travail
...
\newblock [En ligne: Consulté le 20 Octobre 2015].

\bibitem[\bfseries webd]{web01}
...
\newblock {\em UML 2 en action de l'analyse des besoins à la conception J2EE}.
\newblock 3ème édition Ed. EYROLLES, 2004.

\bibitem[\bfseries ROQUES VAL, 2007]{ref08}
Pascal \bgroup\fonteauteurs\bgroup ROQUES\egroup\egroup{} and
Franck  \bgroup\fonteauteurs\bgroup VALLEE\egroup\egroup{} :
\newblock {\em UML 2 en action de l'analyse des besoins à la conception J2EE}.
\newblock 4ème édition Ed. EYROLLES, 2007.

\bibitem[\bfseries ROQUES, 2008]{ref09}
Pascal \bgroup\fonteauteurs\bgroup ROQUES\egroup\egroup{} :
\newblock {\em UML 2 Modéliser une application web }.
\newblock 4ème édition Ed. EYROLLES, 2008.

\bibitem[\bfseries KRIVTSOV, 2014]{ref10}
Oleg \bgroup\fonteauteurs\bgroup KRIVTSOV\egroup\egroup{} :
\newblock {\em Using Zend Framework 2 : Learn how to create modern web applications with PHP and Zend Framework 2 }.
\newblock Leanpub Book, 2014.
...
\newblock Cours d'IGL (Introduction de Génie Logiciel) (1CS), Ecole nationale superieure
d'informatique, ALGER, 2011.

\bibitem[\bfseries webe]{web12}
Choix d'une architecture trois-tiers
\newblock Disponible en ligne sur:
\url{http://cedric.babault.free.fr/rapport/node4.html}.
\newblock [Consulté le 26 Avril 2016].

\bibitem[\bfseries webf]{web20}
Définir une politique de maintenance et sa stratégie de mise en \oe uvre de responsabilités
\newblock Disponible en ligne sur:
\url{http://excerpts.numilog.com/books/9782362330117.pdf}.
\newblock [Consulté le 16 Août 2016].

\bibitem[\bfseries webg]{web21}
Gilles Bougenière 
\newblock Disponible en ligne sur:
\url{ http ://www.osaxis.fr/blog/securiser-ses-applications-symfony-2/}.
\newblock [Consulté le 20 Août 2016].


\bibitem[\bfseries AUDIBERT, 2009]{ref11}
Laurent \bgroup\fonteauteurs\bgroup AUDIBERT\egroup\egroup{} :
\newblock {\em UML 2 De L'apprentissage à La Pratique }.
\url{http://laurent-audibert.developpez.com/Cours-UML/?page=introduction-modelisation-objet#L1-4-3-f},
2009.
\newblock [Consulté le 17 Mai 2016].

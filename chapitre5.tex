...
\begin{itemize}
\item \textbf{Machine 1 :} Toshiba Satellite Pro C660-13C
\begin{itemize}
\item[$\bullet$] Microprocesseur : Intel(R) Core(TM) i3 CPU M380 @ 2.53GHz 2.53GHz,
\item[$\bullet$] RAM : DDR3 4 GB,
\item[$\bullet$] Disque dur : 500 Mo.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Module Statistiques :} contient les contrôleurs et vue pour les statistiques.
...
Les applications Web sont caractérisées par un très grand nombre d'échanges entre l'utilisateur et le serveur. Ces échanges constituent une véritable source de risques qu'il faut maîtriser.\cite{web21}
...
faire très simplement de la communication synchrone dans l'application, c'est-à-dire de la communication en temps réel.socket.io se base sur plusieurs techniques différentes qui permettent la communication en temps réel, La plus connue d'entre elles est WebSocket (API javascript).\\[0.5\baselineskip]
 ...
 C'est la première interface qui apparait au lancement de l'application.
 \begin{figure}[H]
 	\centering
 ...
 \subsection{Fiche équipement}

 L'interface ci-dessous montre la fiche équipement. Elle contient les caractéristiques de l'équipement ainsi que sa nomenclature, sa documentation, et l'historique des intervention sur l'équipement. 
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=1\linewidth]{./image_chapitre5/equipement}
 	\caption{Fiche équipement}
 	\label{fig:interface-auth}
 \end{figure}

 \begin{figure}[H]
 	\centering
 	\includegraphics[width=1\linewidth]{./image_chapitre5/document}
 	\caption{Documentation de l'équipement}
 	\label{fig:interface-auth}
 \end{figure}
 \newpage
  \subsection{Gamme de maintenance}
  
  L'interface ci-dessous montre le mode opératoire d'une gamme de maintenance d'un équipement. Elle contient une description de la gamme, la liste des opérations ainsi que l'organigramme de Gantt des opérations. 
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=1\linewidth]{./image_chapitre5/detail_gamme}
  	\caption{Description et mode opératoire}
  \end{figure}
  
    \begin{figure}[H]
    	\centering
    	\includegraphics[width=1\linewidth]{./image_chapitre5/detail_gamme2}
    	\caption{Description et mode opératoire (suite)}
    \end{figure}
  
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=1\linewidth]{./image_chapitre5/gantt}
  	\caption{Diagramme de Gantt}
  \end{figure}
  
    \subsection{Demande de travail}
    
    L'interface ci-dessous montre la création d'un DT et la fiche DT (Qu'on peut imprimer).
    \begin{figure}[H]
    	\centering
    	\includegraphics[width=1\linewidth]{./image_chapitre5/DT}
    	\caption{Ajouter un DT}
    \end{figure}
    
    \begin{figure}[H]
    	\centering
    	\includegraphics[width=1\linewidth]{./image_chapitre5/DT2}
    	\caption{Fiche DT}
    \end{figure}
    
    \subsection{Ordre de travail}
    
    L'interface ci-dessous montre la création d'un OT.
    \begin{figure}[H]
       	\centering
       	\includegraphics[width=1\linewidth]{./image_chapitre5/OT}
       	\caption{Ajouter un OT}
    \end{figure}
    
        \subsection{Planning des interventions}
        
        L'interface ci-dessous montre le planning des interventions préventives et correctives.
        \begin{figure}[H]
        	\centering
        	\includegraphics[width=1\linewidth]{./image_chapitre5/planning}
        	\caption{Planning des interventions}
        \end{figure}
 ...
 Nous avons, par la suite, présenté les interfaces les plus significatives de notre application moyennant des captures d'écrans.